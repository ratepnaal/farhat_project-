...
export default function ContactArPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    const text = `الاسم: ${fullName}%0Aالموضوع: ${subject}%0Aالرسالة: ${message}`
    ...
    <div dir={dir}>
      ...
      <main className="container-custom py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Contact Form */}
          <div>
            <h2 className="text-3xl font-bold mb-8 text-gradient text-center">أرسل لنا رسالة</h2>
          ...
          <div className="flex flex-col items-center justify-center">
            <h2 className="text-3xl font-bold mb-8 text-gradient text-center">موقعنا</h2>
